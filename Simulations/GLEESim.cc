...
int main(int argc, char** argv)
{
    ...
    runManager->SetUserInitialization(new GLEESimDetectorConstruction());

    // Physics List
    runManager->SetUserInitialization(new GLEESimPhysicsList());

    // User action Initialization
    runManager->SetUserInitialization(new GLEESimActionInitialization());
